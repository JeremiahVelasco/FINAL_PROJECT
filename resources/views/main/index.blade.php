...
@section('content')
    ...
    <div class="bg-gray-900">
        ...
        <div class="relative mx-auto md:mt-8">
            <div class="lg:max-w-6xl lg:mx-auto gap-32 h-24 flex flex-row justify-around place-items-center rounded-lg"
        ...
        @foreach ($articles as $article)
            <div class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
                <div class="p-8 sm:p-10 lg:flex-auto">
                    <h3 class="text-md font-semibold tracking-tight text-indigo-600">ARTICLE</h3>
                    <p class="mt-6 text-3xl font-bold leading-7 text-gray-50">{{ $article->title }}</p>
                    <ul role="list"
                        ...
                        <li class="flex gap-x-3">
                            ...
                            Published by {{ $article->user->name }}
                        </li>
                        <li class="flex gap-x-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                class="w-6 h-6 text-indigo-600">
                ...
                <div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
                    <div
                        class="rounded-2xl bg-indigo-900 py-10 text-center ring-1 ring-inset ring-gray-900/5 lg:flex lg:flex-col lg:justify-center lg:py-16">
                        <div class="mx-auto max-w-xs px-8">
                            <p class="text-base font-semibold text-gray-400">Pay once, own it forever</p>
                            <p class="mt-6 flex items-baseline justify-center gap-x-2">
                                <span class="text-5xl font-bold tracking-tight text-gray-50">$349</span>
                                <span class="text-sm font-semibold leading-6 tracking-wide text-gray-500">USD</span>
                            </p>
                            <a href="#"
                                ...
                                access</a>
                            <p class="mt-6 text-xs leading-5 text-gray-400">Invoices and receipts available for easy company
                                reimbursement</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="bg-gray-900">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-px lg:max-w-7xl lg:px-8">
