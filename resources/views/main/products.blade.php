...
@section('content')
    // TODO : Fix this tailwind component
                ...
                <div class="fixed inset-0 z-40 flex">
                    <div
                        ...
                        <div class="flex items-center justify-between px-4">
                            <h2 class="text-lg font-medium text-gray-50">Filters</h2>
                            <button type="button"
                        ...
                        <form class="mt-4 border-t border-gray-200">
                            ...
                            <ul role="list" class="px-2 py-3 font-medium text-gray-50">
                                <li>
                            ...
                            <div class="border-t border-gray-200 px-4 py-6">
                                <h3 class="-mx-2 -my-3 flow-root">
                                    ...
                                    <button type="button"
                                        ...
                                        <span class="font-medium text-gray-50">Color</span>
                            ...
                            <div class="border-t border-gray-200 px-4 py-6">
                                <h3 class="-mx-2 -my-3 flow-root">
                                    ...
                                    <button type="button"
                                        ...
                                        <span class="font-medium text-gray-50">Category</span>
                                        <span class="ml-6 flex items-center">
                                            <!-- Expand icon, show/hide based on section open state. -->
                            ...
                            <div class="border-t border-gray-200 px-4 py-6">
                                <h3 class="-mx-2 -my-3 flow-root">
                                    ...
                                    <button type="button"
                                        ...
                                        <span class="font-medium text-gray-50">Size</span>
                                        <span class="ml-6 flex items-center">
                                            <!-- Expand icon, show/hide based on section open state. -->
                                            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"
                                                aria-hidden="true">
                ...
                <section aria-labelledby="products-heading" class="pb-24 pt-6">
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                        ...
                        <form class="hidden lg:block">
                            <h3 class="sr-only">Categories</h3>
                            <ul role="list"
                                class="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-50">
                                <li>
                                    <a href="#">Totes</a>
                                </li>
                                <li>
                            ...
                            <div class="border-b border-gray-200 py-6">
                                <h3 class="-my-3 flow-root">
                                    <!-- Expand/collapse section button -->
                                    <button type="button"
                                        class="flex w-full items-center justify-between bg-gray-800 py-3 px-2 text-sm text-gray-200 hover:text-gray-200"
                                    ...
                                    <div class="space-y-4">
                                        <div class="flex items-center">
                                            <input id="filter-color-0" name="color[]" value="white" type="checkbox"
                                                class="h-4 w-4 rounded border-gray-50 text-indigo-600 focus:ring-indigo-500">
