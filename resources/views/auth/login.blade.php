<x-guest-layout>
    ...
    <div class="mt-10 flex text-center justify-center">
        <a href="{{ route('google-auth') }}"
            class="flex items-center bg-white border border-button-border-light rounded-md p-0.5 pr-3 hover:bg-gray-300">
