            ...
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        @guest
                            <a href="{{ route('login') }}"
                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-semibold rounded-md text-gray-50 hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                    ...
                    <x-slot name="content">
                        ...
                        {{-- TODO: change to cart route once implemented --}}
                        <!-- Cart -->
                        <x-dropdown-link :href="route('profile.edit')">
                            {{ __('Cart') }}
                        </x-dropdown-link>
            ...
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        <img src="/storage/assets/cubicwave_white.svg" class="h-8 me-3" alt="FlowBite Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">CubicWave</span>
                    </a>
                </div>
